...
This project concerns itself with importing and using functions and creating
modules in Python, using the builtin function `dir()` and using command line arguments
